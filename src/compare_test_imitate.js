...
//    for(var i = 0;i <= 3; i ++){
//        for(var j = 0;j <= 3; j ++){
//            console.log(guess_number.toString())
//            console.log(random_number.toString())
////            console.log(guess_number[0])
////            console.log(random_number.toString()[j])
...
//    var sorting = realize_analysis(number_is_guess, random_number)
    console.log(random_number)
    if(random_number != guess_number && number_of_time == 6){
        button_disabled(true)
        export_label("对不起，您没有猜对数字，随机数字为:" + random_number)
